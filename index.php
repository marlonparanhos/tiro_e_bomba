...
<body>
	<div class="container-fluid content table-responsive table-full-width">
		<table id="tabelaJogadas" class="table table-striped table-hover">
			<!-- <table hidden id="tabelaJogadas" style="width:100%;"> -->
				<thead>
					<tr>
		...
		<div class="tamanhoTexto container text-center">
			...
			<button class="btn btn-primary btn-page btn-lg" id="enviarNum">ENVIAR</button>
			...
			<div hidden id="divChutes">
				...
				<button class="btn btn-success btn-page btn-lg" id="chutar">CHUTAR</button>
			</div>
	...
	<script>
		...
		$("#enviarNum").click(function(e){
			...
			if (!$("#numJogador1").val()) {
				return alert("Coloca os números aí, caralho!");
			}
